...
type AuctionVehicle struct {
	...
	LastestBiddingDate time.Time `json:"lastest_bidding_date" query:"lastest_bidding_date"`
	LastestProcessDate time.Time `json:"lastest_proces_date" query:"lastest_process_date"`
