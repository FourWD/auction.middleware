...
type RegisterLeasing struct {
	...
	UpdatedLoanStatusBy string    `json:"updated_loan_status_by" query:"updated_loan_status_by" gorm:"type:varchar(36)"`
	UpdatedLoanStatusAt time.Time `json:"updated_loan_status_at" query:"updated_loan_status_at" `
}
